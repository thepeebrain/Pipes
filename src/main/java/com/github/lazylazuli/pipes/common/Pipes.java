...
@Mod(modid = Pipes.MODID, version = Pipes.VERSION + "-" + Pipes.BUILD, acceptedMinecraftVersions = Pipes.MCVERSION,
		dependencies = "required-after:lazylazulilib@[2.0.0]", updateJSON = Pipes.UPDATE)
public final class Pipes extends LazyLazuliMod
{
	...
	@SidedProxy(clientSide = "com.github.lazylazuli.pipes.client.ClientProxy", serverSide = "com.github.lazylazuli" +
			".pipes.common.CommonProxy")
